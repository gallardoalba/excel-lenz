...
- Name: formula-editing.spec.ts >> Nested & Complex Formulas >> nested WENN inside SUMME
- Location: e2e/formula-editing.spec.ts:498:3
          ...
          - region "Excel-Arbeitsblatt" [ref=f1e105]:
            - generic [ref=f1e107]:
              - generic [ref=f1e108]:
                - generic [ref=f1e109]:
                  - generic [ref=f1e110]:
                    ...
                    - button "Rückgängig" [ref=f1e114] [cursor=pointer]
              ...
              - region "Bearbeitungsleiste" [ref=f1e272]:
                ...
                - generic [ref=f1e278]:
                  - combobox "Formel eingeben" [ref=f1e279]: =WENN(SUMME(10;20)>25;"Groß";"Klein") =WENN(SUMME(10;20)>25;"Groß";"Klein")
              ...
              - treegrid [ref=f1e285]:
                - rowgroup [ref=f1e294]:
                  - row [ref=f1e295]:
                    ...
                    - gridcell [ref=f1e300]
                  - row [ref=f1e301]:
                    - gridcell "Groß" [active] [selected] [ref=f1e302]
                ...
                - rowgroup [ref=f1e373]:
                  - row [ref=f1e374]:
                    - gridcell "Select whole grid" [ref=f1e375]
                    - columnheader "A" [ref=f1e376]:
                      - text: A
                      - button [ref=f1e377]
                    - columnheader "B" [ref=f1e378]:
                      - text: B
                      - button [ref=f1e379]
                    - columnheader "C" [ref=f1e380]:
                      - text: C
                      - button [ref=f1e381]
                    - columnheader "D" [ref=f1e382]:
                      - text: D
                      - button [ref=f1e383]
                    - columnheader "E" [ref=f1e384]:
                      - text: E
                      - button [ref=f1e385]
                - rowgroup
                - rowgroup [ref=f1e388]:
                  - row [ref=f1e389]:
                    - rowheader "1" [ref=f1e390]
                  - row [ref=f1e393]:
                    - rowheader "2" [ref=f1e394]
                  - row [ref=f1e397]:
                    - rowheader "3" [ref=f1e398]
                  - row [ref=f1e401]:
                    - rowheader "4" [ref=f1e402]
                  - row [ref=f1e405]:
                    - rowheader "5" [ref=f1e406]
                  - row [ref=f1e409]:
                    - rowheader "6" [ref=f1e410]
                  - row [ref=f1e413]:
                    - rowheader "7" [ref=f1e414]
                  - row [ref=f1e417]:
                    - rowheader "8" [ref=f1e418]
                  - row [ref=f1e421]:
                    - rowheader "9" [ref=f1e422]
                  - row [ref=f1e425]:
                    - rowheader "10" [ref=f1e426]
                  - row [ref=f1e429]:
                    - rowheader "11" [ref=f1e430]
                - rowgroup [ref=f1e435]:
                  - row [ref=f1e436]:
                    - gridcell "Select whole grid" [ref=f1e437]
                - rowgroup
                - textbox [ref=f1e439]: =WENN(SUMME(10;20)>25;"Groß";"Klein")
              - generic [ref=f1e440]:
                - generic [ref=f1e441]:
                  - button "Tabelle1" [ref=f1e442] [cursor=pointer]
                  - button "+" [ref=f1e443] [cursor=pointer]
                - generic [ref=f1e444]: Bereit
                - generic [ref=f1e447]:
                  - button "−" [ref=f1e448] [cursor=pointer]
                  - slider [ref=f1e450]: "100"
                  - button "+" [ref=f1e451] [cursor=pointer]
                  - button "100%" [ref=f1e452] [cursor=pointer]
    - contentinfo [ref=f1e453]:
      - generic [ref=f1e454]:
        - generic [ref=f1e455]:
          - generic [ref=f1e456]: Excel-lenz
          - paragraph [ref=f1e459]: Interaktives Excel-Lernportal für Praxis, Feedback und individuelle Lernpfade.
        - generic [ref=f1e460]:
          - heading "Kurse" [level=4] [ref=f1e461]
          - list [ref=f1e462]:
            - listitem [ref=f1e463]:
              - link "Excel-Grundlagen" [ref=f1e464] [cursor=pointer]:
                - /url: /courses
            - listitem [ref=f1e465]:
              - link "Fortgeschrittene Techniken" [ref=f1e466] [cursor=pointer]:
                - /url: /courses
            - listitem [ref=f1e467]:
              - link "Individuelle Lernpfade" [ref=f1e468] [cursor=pointer]:
                - /url: /courses
        - generic [ref=f1e469]:
          - heading "Entwickler" [level=4] [ref=f1e470]
          - list [ref=f1e471]:
            - listitem [ref=f1e472]:
              - link "Über den Entwickler" [ref=f1e473] [cursor=pointer]:
                - /url: /entwickler
            - listitem [ref=f1e474]:
              - link "GitHub Repository" [ref=f1e475] [cursor=pointer]:
                - /url: https://github.com/gallardoalba/excel-lenz
            - listitem [ref=f1e476]: Freiburg, Deutschland
        - generic [ref=f1e477]:
          - heading "Rechtliches" [level=4] [ref=f1e478]
          - list [ref=f1e479]:
            - listitem [ref=f1e480]:
              - link "Impressum" [ref=f1e481] [cursor=pointer]:
                - /url: /impressum
            - listitem [ref=f1e482]:
              - link "Datenschutz" [ref=f1e483] [cursor=pointer]:
                - /url: /datenschutz
            - listitem [ref=f1e484]:
              - link "AGB" [ref=f1e485] [cursor=pointer]:
                - /url: /agb
      - generic [ref=f1e486]: © 2026 Excel-lenz. Alle Rechte vorbehalten.
  - status [ref=f1e487]
```
...
```ts
  416 |   test('WURZEL (German SQRT) works', async ({ page }) => {
  417 |     await navigateToExercise(page);
  418 | 
  419 |     const formulaBar = page.locator('.formulabar-input').first();
  420 |     await formulaBar.click();
  421 |     await formulaBar.fill('=WURZEL(16)');
  422 |     await page.keyboard.press('Enter');
  423 |     await page.waitForTimeout(500);
  424 | 
  425 |     const cellContent = await page.locator('.ht_master tbody tr:nth-child(2) td:nth-child(2)').textContent();
  426 |     // Should be 4
  427 |     expect(cellContent).not.toMatch(/#NAME\?/);
  428 |   });
  429 | });
  430 | 
  431 | // ─────────────────────────────────────────────────────────────────────
  432 | // CELL REFERENCE & ARITHMETIC FORMULAS
  433 | // ─────────────────────────────────────────────────────────────────────
  434 | 
