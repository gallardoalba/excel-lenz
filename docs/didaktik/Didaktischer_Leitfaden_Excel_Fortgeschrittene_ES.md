---
pdftitle: "Guía Didáctica: Excel Avanzado para Usuarios Profesionales"
...
\thispagestyle{empty}
\begin{center}
{\Huge\bfseries\sffamily\color{excelblue}Guía Didáctica\par}
\vspace{0.3em}
{\Large\sffamily Excel Avanzado para Usuarios Profesionales\par}
\vspace{1.5em}
{\large\sffamily Curso Presencial Individual para Adultos — 8 Sesiones\par}
\vspace{2.5em}
{\normalsize\sffamily\color{excelgray}
\textbf{Autor:} Cristóbal Gallardo\par
\vspace{0.2em}
\textbf{Fecha:} Agosto 2026\par
\vspace{0.2em}
\textbf{Localización:} Freiburg im Breisgau\par
\vspace{0.2em}
\textbf{Duración:} 12 horas (8 sesiones $\times$ 90 minutos)\par
\vspace{0.2em}
\textbf{Modalidad:} Presencial individual con práctica en Microsoft Excel\par
\vspace{0.2em}
\textbf{Recurso complementario:} Plataforma web Excel-lenz\par
}
\end{center}
\vfill
\newpage
...
| Formato condicional con fórmulas | Diseñar reglas complejas (=$F5="TX", =Y(B4>HOY();...)) | Atención a la lógica de las condiciones |
...
**Módulo integrado**: M5 (Tablas dinámicas y gráficos dinámicos)  
**Duración**: 90 minutos  
**Enfoque**: Teórico-práctico
...
- Añadir líneas de tendencia a gráficos e interpretar el valor R²
...
| Regresión lineal y ajuste de curvas | Añadir líneas de tendencia y analizar R² | Curiosidad por la modelización predictiva |
...
| Demostración | 20 min | Construcción de un modelo de rentabilidad: sparklines para tendencias, línea de tendencia con R², Buscar Objetivo para punto de equilibrio, Solver para maximizar beneficios con restricciones |
...
El plan de estudios **Excel para usuarios avanzados** consta de 10 módulos con un total de
**39 ejercicios**, impartidos en 8 sesiones de 90 minutos. Todos los ejercicios están
disponibles como archivos Excel (`.xlsx`) en la carpeta `exercises/fortgeschrittene/`.
...
**Nota:** Power Pivot (M5.5), Buenas prácticas de VBA (M9.5) y Complementos/Power Query
(M10.3) están concebidos como temas de perspectiva y no tienen archivos de ejercicios propios.
