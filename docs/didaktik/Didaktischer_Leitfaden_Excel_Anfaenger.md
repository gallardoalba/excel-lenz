---
pdftitle: "Didaktischer Leitfaden: Excel für Anfänger"
...
\vspace{1.5em}
{\large\sffamily Präsenz-Einzelkurs für Erwachsene — 8 Sitzungen\par}
\vspace{2.5em}
...
\vspace{0.2em}
\textbf{Modus:} Präsenz-Einzelunterricht mit Praxis in Microsoft Excel\par
\vspace{0.2em}
...
**Integriertes Modul**: M5 (Bereinigung, Validierung und Datenverwaltung)  
**Dauer**: 90 Minuten  
**Schwerpunkt**: Praxis
...
| Konzeptuell | Prozedural | Einstellungsbezogen |
|-------------|------------|---------------------|
| Prinzip der Schlüsselsuche | SVERWEIS mit exakter und ungefährer Übereinstimmung erstellen | Geduld bei syntaktischer Komplexität |
...
**Integrierte Module**: M9 (Pivot-Tabellen) + M10 (Was-wäre-wenn-Analyse)  
**Dauer**: 90 Minuten  
**Schwerpunkt**: Theorie-Praxis
