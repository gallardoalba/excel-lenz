...
> **Tipp:** `Strg+Leertaste` = ganze Spalte, `Shift+Leertaste` = ganze Zeile.
...
> Öffnen Sie die Datei `M2_1_Datentypen.xlsx`. Geben Sie in verschiedene Zellen ein:
>
> - Ihren Namen (Text)
>
> - Die Zahl 1500 (Zahl)
...
> Öffnen Sie die Datei `M2_2_Bearbeiten.xlsx`. Die Tabelle enthält absichtlich
...
> Öffnen Sie die Datei `M2_3_AutoAusfuellen.xlsx`.
>
...
> Öffnen Sie die Datei `M2_4_Kopieren.xlsx`.
>
...
|----------|-------------|---------|
| Fett | `Strg+Shift+F` | Text hervorheben (Überschriften) |
| Kursiv | `Strg+Shift+K` | Hervorhebung im Fließtext |
| Unterstrichen | `Strg+Shift+U` | Besonders wichtige Werte |
...
> Öffnen Sie die Datei `M3_1_Grundformatierung.xlsx`. Formatieren Sie die Tabelle so:
>
...
> Öffnen Sie die Datei `M3_2_Zahlenformat.xlsx`.
>
...
> `Shift+Leertaste` die gesamte Zeile. Dann können Sie mit Rechtsklick schnell
> einfügen, löschen oder ausblenden.

**Übung 3.3 — Layout anpassen**

> Öffnen Sie die Datei `M3_3_Layout.xlsx`.
>
...
> Öffnen Sie die Datei `M3_4_Bedingte_Formatierung.xlsx`.
>
...
> Öffnen Sie die Datei `M4_1_Erste_Formeln.xlsx`.
>
...
> Öffnen Sie die Datei `M4_2_Zellbezuege.xlsx`.
>
...
## 4.3. Statistische Grundfunktionen
...
> Öffnen Sie die Datei `M4_3_Statistik.xlsx`.
>
...
> Öffnen Sie die Datei `M4_4_WENN.xlsx`.
>
...
> Öffnen Sie die Datei `M5_1_Validierung.xlsx`.
>
...
> Öffnen Sie die Datei `M5_2_Bereinigen.xlsx`.
>
...
> Öffnen Sie die Datei `M5_3_Konsolidierung.xlsx`.
>
...
> Öffnen Sie die Datei `M5_4_Import.xlsx` als Ausgangspunkt.
>
...
> Öffnen Sie die Datei `M6_1_Sortieren.xlsx`.
>
...
> Öffnen Sie die Datei `M6_2_Filtern.xlsx`.
>
> 1. Aktivieren Sie den Autofilter (`Strg+Shift+L`).
...
> Öffnen Sie die Datei `M6_3_Tabellen.xlsx`.
>
...
## 6.4. Teilergebnisse und Gliederung
...
> Öffnen Sie die Datei `M6_4_Teilergebnisse.xlsx`.
>
...
> Öffnen Sie die Datei `M7_1_Bedingte_Summen.xlsx`.
>
...
> Öffnen Sie die Datei `M7_2_SVERWEIS.xlsx`.
>
...
> Öffnen Sie die Datei `M7_3_INDEX_VERGLEICH.xlsx`.
>
...
| `GROSS2(Text)` | Erster Buchstabe groß | `=GROSS2("max")` | `Max` |
...
> Öffnen Sie die Datei `M7_4_Text_Datum.xlsx`.
>
...
> Öffnen Sie die Datei `M8_1_Erste_Diagramme.xlsx`.
>
...
> Öffnen Sie die Datei `M8_2_Diagrammformat.xlsx`.
>
...
> Öffnen Sie die Datei `M8_3_Verbunddiagramm.xlsx`.
>
...
> Öffnen Sie die Datei `M8_4_Dashboard.xlsx`.
>
...
> Öffnen Sie die Datei `M9_1_Pivot.xlsx`.
>
...
> Öffnen Sie die Datei `M9_2_Pivot_Anpassung.xlsx`.
>
...
> Öffnen Sie die Datei `M9_3_Slicer.xlsx`.
>
...
> Öffnen Sie die Datei `M9_4_PivotChart.xlsx`.
>
...
> Öffnen Sie die Datei `M10_1_Zielwertsuche.xlsx`.
>
...
> Öffnen Sie die Datei `M10_2_Finanzfunktionen.xlsx`.
>
...
> Öffnen Sie die Datei `M11_1_Drucklayout.xlsx`.
>
...
> Öffnen Sie die Datei `M11_2_Druckbereich.xlsx`.
>
...
> Öffnen Sie die Datei `M11_3_Kopfzeilen.xlsx`.
>
...
> Öffnen Sie die Datei `M11_4_Zusammenarbeit.xlsx`.
>
...
> Öffnen Sie die Datei `M12_1_Schutz.xlsx`.
>
...
| `Strg+Shift+L` | Autofilter an/aus | L wie „Liste" |
...
> Öffnen Sie die Datei `M12_2_Tastenkombinationen.xlsx` und bearbeiten Sie sie
> ausschließlich mit Tastenkombinationen:
>
> 1. `Strg+Shift+L` für Filter, dann mit Pfeiltasten navigieren.
...
> Öffnen Sie die Datei `M12_3_Inspektion.xlsx`.
>
...
> Öffnen Sie die Datei `M13_1_Entwicklertools.xlsx`.
>
...
> Öffnen Sie die Datei `M13_2_Makro_Aufzeichnen.xlsx`.
>
...
> Öffnen Sie die Datei `M13_3_VBA_Editor.xlsx`.
>
...
> Öffnen Sie die Datei `M13_4_VBA_Programmieren.xlsx`.
>
